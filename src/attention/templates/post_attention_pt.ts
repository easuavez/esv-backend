														...
														<tr>
															<td class="pad" style="padding-right:10px;text-align:center;width:100%;">
																<h1 style="margin: 0; color: #000000; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 32px; font-weight: 400; letter-spacing: -2px; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">
																	Olá, bem-vindo a <strong>{{commerce}}</strong> 👋🏼</span>
																</h1>
															</td>
														</tr>
													</table>
															...
															<td class="pad" style="padding-left:30px;padding-right:30px;padding-top:10px;text-align:center;width:100%;">
																<h1 style="margin: 0; color: #000000; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 14px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
																	<span class="tinyMce-placeholder">
																		<p style="font-size: 20px;">Muito obrigado por se atender conosco!</p><br>
																		<p style="font-size: 15px;">Anexado a este e-mail, você encontrará um documento com algumas especificações, instruções e/ou detalhes adicionais que você deve considerar para concluir com sucesso seu atendimento ou procedimento conosco.</p><br>
																		<p style="font-size: 15px;">⚠️ IMPORTANTE: Leia com atenção e caso tenha alguma dúvida ou dúvida entre em contato conosco. </p>
													...
													<table class="heading_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-bottom:5px;text-align:center;width:100%;">
																<h1 style="margin: 0; margin-left:1rem; color: #ffffff; direction: ltr; font-family: Arial, Helvetica, sans-serif; font-size: 18px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><a href="https://www.easuavez.com" target="_blank" style="text-decoration: none; color: #ffffff;" rel="noopener">easuavez.com</a></h1>
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, Helvetica, sans-serif;font-size:8px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:9.6px;">
																	<p style="margin: 0;">Enviado por&nbsp;<strong>É a sua vez<br></strong><a href="mailto:hola@easuavez.com" target="_blank" rel="noopener" title="ola@easuavez.com" style="text-decoration: underline; color: #000000;">ola@easuavez.com</a>&nbsp;<br>Se você não deseja mais receber mensagens como esta, por favor nos avise.</p>
																</div>
															</td>
														</tr>
													</table>
